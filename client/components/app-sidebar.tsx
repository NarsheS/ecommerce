...
import { AppWindow, Boxes, ChartArea, DollarSign, Home, NotebookText, Star, Store, User2 } from "lucide-react"
...
const items = [
  ...
  { title: "Faturamento", url: "/dashboard/analytics", icon: ChartArea },
]
